...
class DefineDoseFromCT:
    ...
    def make_convolution_block(self, x: Any, num_filters: int, use_batch_norm: bool = True) -> Any:
    ...
    def make_convolution_transpose_block(
        self, x: Any, num_filters: int, use_dropout: bool = True, skip_x: Optional[Any] = None
    ) -> Any:
